 ...
 * ====================================================================== */
  ...
  WhatsappChatSupport.DEFAULTS = {
    ...
    dialogNotAvailableMsg:
      "Estamos fuera de horario <a href='https://blog.hubspot.es/website/chat-vivo-sitio-web'>a</a>", // message when its not an available day or once the available hours have passed
